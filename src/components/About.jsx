      ...
      <div className=" max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative h-[500px] md:h-[600px]">
            ...
            <div className="absolute top-20 left-0 w-1/2 h-64 overflow-hidden rounded-xl border-white">
              <img 
                src={Image1} 
            ...
            {/* 2. Big Image (Bottom Right) - Overlapping Small Image */}
            <div className="absolute bottom-0 right-0 w-3/4 h-[350px] overflow-hidden rounded-xl border-white z-10">
              <img 
                src={Image2} 
            ...
            {/* 3. Empty Top Right: Brand Logo Badge */}
            <div className="absolute top-24 right-4 md:right-10 bg-white p-6 rounded-3xl flex items-center justify-center border border-gray-200 ">
            ...
            {/* 4. Empty Bottom Left: Years of Experience Badge */}
...
>
 ...
 E-Construct Design and Building .pvt .ltd           </h2>

            <p className="text-gray-600 leading-relaxed text-xl">
ECONSTRUCT is a premier Indian consultancy and contracting firm dedicated to redefining residential and commercial spaces. Operating with global benchmarks of transparency, reliability, and sustainability, we transform client dreams into high-quality reality. From Mumbai to Bangalore, our commitment to excellence and timely delivery remains our greatest mission.            </p>
